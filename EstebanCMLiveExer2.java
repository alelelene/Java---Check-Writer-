...
public class EstebanCMLiveExer2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(isValidDate == false)
        {
            ...
            try {
                inputDateString = input.readLine();
        ...
        String amountString = " PESOS: **" + convert(amount) + "ONLY**";
        String nameString = "\n PAY TO THE ORDER OF: " + name;
        

            for(int i = 0; i < (57 - (name.length()+22)); i++)
        {
            nameString += " ";
        }
    ...
    public static String convert(double amount)
    {
        ...
        int centavos = Integer.parseInt(centavosArr[1]);
        String result = "";
